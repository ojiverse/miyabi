/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 17aba7a3a35c42638c18095589ba11b7)
...
declare namespace Cloudflare {
	...
	interface Env {
		...
		miyabi_db: D1Database;
		AI: Ai;
		miyabi_workflow: Workflow<Parameters<import("./src/index").MiyabiWorkflow['run']>[0]['payload']>;
